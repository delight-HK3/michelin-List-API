...
| 파라미터명 | 설명 | 데이터타입 | 필수여부 | 
| ------ | ------ | ----- | ----- |
| row | 불러올 행 수 | Integer | X |
| fcltyNm | 레스토랑 이름 | String | X |
| starCnt | 별 개수 | Integer | X |
| year | 획득년도 | Integer | X |
| ctprvnEngNm | 시도영문명 | String | X |

#### 사용예시
```
https://4m2jy6af81.execute-api.ap-northeast-2.amazonaws.com/api/michelin_list?row=100&starCnt=1&year=2024
```
해석) 2024년도에 선정되었고 별을 1개만 받은 레스토랑을 100건 조회
